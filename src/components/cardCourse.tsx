...
type detailCourseProp = StackNavigationProp<RootStackParamList, 'DetailCourse'>;

const CardCourse = () =>{
    const navigation = useNavigation<detailCourseProp>();
    ...
    return(
        <TouchableOpacity style={styles.container} onPress={() => navigation.navigate('DetailCourse')}>
            ...
            <View style={styles.textView}>
                <Text style={{...styles.text,color:'#5BA092'}}>
                    3 h 30 min
                </Text>
